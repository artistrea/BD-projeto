	...
	<form on:submit={handleSubmit} class="bg-secondary rounded flex flex-col p-8 h-auto justify-center mt-10 w-1/3">
        ...
        {#if item.type === 'livro'}
            ...
            <div class="flex flex-col">
                ...
                <input class="bg-transparent border-b border-primary px-4 py-2" type="date" id="dataDeAquisicao" on:change={(e) => item.dataDeAquisicao = new Date(e.currentTarget.value).toUTCString()}>
            </div>
            <div class="flex flex-col">
